        ...
        <header class="navbar navbar-expand-md navbar-light d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="#">
                        <img src="{{ asset('static/logo-side.png') }}" width="110" height="32" alt="Tabler"
                            ...
                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title">List Notifikasi</h3>
                                    </div>
                                        ...
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col text-truncate">
                                                    <a href="{{ route('picapprove.index') }}" class="text-body d-block">
                                                        Pengajuan Kredit
                                                    </a>
                                                    <div class="d-block text-muted text-truncate mt-n1">
                                                        Status pengajuan <span
                                                            class="badge rounded-pill text-bg-warning">Pending</span>
                                                        atas nama {{ $submission->employee_name }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <div class="d-none d-xl-block ps-2">
                                <div>{{ Auth::user()->employee->employee_name ?? '' }}</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            <a href="{{route('account.edit', Auth::user()->id)}}" class="dropdown-item">Account</a>
                            <a href="/login/unauthenticate" class="dropdown-item">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="https://wa.me/{{ Auth::user()->company->phone }}"
                                    ...
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                        <!-- Download SVG icon from http://tabler-icons.io/i/package -->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="icon icon-tabler icon-tabler-brand-whatsapp" width="28" height="28"
                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
